...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        usstr = user.__str__()
        self.assertIn("[User] (0123456)", usstr)
        self.assertIn("'id': '0123456'", usstr)
        self.assertIn("'created_at': " + date_repr, usstr)
        self.assertIn("'updated_at': " + date_repr, usstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user = User(id="012", created_at=date_iso, updated_at=date_iso)
        self.assertEqual(user.id, "012")
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        user = User()
        user.middle_name = "Ahmed"
        user.my_number = 27
        self.assertEqual("Ahmed", user.middle_name)
